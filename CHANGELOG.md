...
- Hero headline/subtext still wrapping well short of the terminal's width above them despite the earlier 26ch fix: removed hero__headline's max-width entirely and widened hero__sub from 62ch to 90ch
- Aligned portfolio content to the Shuru "Head of Engineering" CV + cover letter: rewrote Uppercase experience bullets (ERP/POS/OMS/DMS ownership, DPDP/data-security compliance, Google Workspace to M365 migration, vendor management, 17%/8% forecast/inventory numbers), added retail-systems/ and security-governance/ skill categories, refreshed about.md lede/body and tags (added sap)
